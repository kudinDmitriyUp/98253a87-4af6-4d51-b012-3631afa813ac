...
export const metadata: Metadata = {
  title: "STREETWEAR CO - Bold Urban Fashion & Authentic Collections",
  description: "Shop premium streetwear and urban apparel. Authentic designs for bold styles. New drops, exclusive collections, and community-driven fashion.",
  keywords: "streetwear, urban fashion, hoodies, cargo pants, sneakers, streetwear brand, urban clothing",
  metadataBase: new URL("https://streetwearco.com"),
  alternates: {
    canonical: "https://streetwearco.com"
  },
  openGraph: {
    title: "STREETWEAR CO - Urban Fashion Redefined",
    description: "Discover authentic streetwear that defines your bold style. Premium quality urban apparel.",
    url: "https://streetwearco.com",
    siteName: "STREETWEAR CO",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764062200196-0ym0xerm.jpg",
  ...
  twitter: {
    ...
    title: "STREETWEAR CO - Bold Urban Fashion",
    description: "Premium streetwear for authentic urban style",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764062200196-0ym0xerm.jpg"]
  },
  robots: {
    index: true,
    follow: true
